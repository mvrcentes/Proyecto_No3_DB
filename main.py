		...
		try:
			...
			# <======================= EXTRAS (NO PTS) =======================> 
				...
				print(
					...
					"\n\tget 'nombre_tabla',1,{COLUMN=>'columna:valor'} ---> ejemplo {COLUMN => 'movie_details:title'}"+ # ejemplo 
			...
			with open('./Hfile.bin', 'wb') as file:
				pickle.dump(hbase, file)
		except:
...
if __name__ == "__main__":
	...
	if (os.path.exists("./Hfile.bin")):
		with open('./Hfile.bin', 'rb') as file:
			hbase = pickle.load(file)
	main(hbase)
